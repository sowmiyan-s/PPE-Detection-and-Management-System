...
```bash
git clone https://github.com/sowmiyan-s/PPE-Detection-and-Management-System.git /opt/cerberus-ai
cd /opt/cerberus-ai
...
Documentation=https://github.com/sowmiyan-s/PPE-Detection-and-Management-System
